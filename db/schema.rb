...
ActiveRecord::Schema.define(version: 20151201115525) do
  ...
  add_index "hydrometers", ["prince_id"], name: "index_hydrometers_on_prince_id", using: :btree
  ...
  create_table "readings", force: :cascade do |t|
    ...
    t.integer  "consumptionAll",  limit: 4
  ...
  add_foreign_key "hydrometers", "princes"
