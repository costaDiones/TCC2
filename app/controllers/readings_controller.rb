class ReadingsController < ApplicationController
  ...
  def create
    ...
    if @reading.consumption > 10000
      valorNormal = @reading.hydrometer.prince.valueAbove
      consumoAcima = @reading.consumption - 10000
      valorAcima = valorNormal * consumoAcima
      @reading.invoiceValue  = valorAcima + @reading.hydrometer.prince.valueNormal

    else
      @reading.invoiceValue  =  @reading.hydrometer.prince.valueNormal
  ...
  if @reading.paid == nil
      ...
      @reading.consumptionAll  = @reading.reading * 1000
  ...
  private
    ...
    def reading_params
      params.require(:reading).permit(:date_reading, :reading, :consumption, :month_reference, :invoiceValue, :paid, :hydrometer_id, :consumptionAll)
    end
end
